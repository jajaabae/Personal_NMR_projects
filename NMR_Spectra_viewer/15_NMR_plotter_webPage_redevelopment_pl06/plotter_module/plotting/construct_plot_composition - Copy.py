...
def construct_plot_composition(plt, size_x_and_y, height_1D, height_labels):
    #size_x_and_y = 20*2
    ...
    top = plt.subplot2grid((x, y), (0, height_1D), colspan=x-height_1D-height_labels, rowspan=height_1D)
    left = plt.subplot2grid((x, y), (height_1D, 0), colspan=height_1D, rowspan=y-height_1D-height_labels)

    bot = plt.subplot2grid((x, y), (y-height_labels, height_1D), colspan=x-height_1D-height_labels, rowspan=height_labels)
    right = plt.subplot2grid((x, y), (height_1D, x-height_labels), colspan=height_1D, rowspan=y-height_1D-height_labels)
    ...
    main = plt.subplot2grid((x, y), (height_1D, height_1D), colspan=x-height_1D-height_labels, rowspan=y-height_1D-height_labels)
